...
export default function StudentPredict() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Self Assessment</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Enter your current academic details to evaluate your trajectory
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          <h2 className="text-lg font-semibold text-slate-800 dark:text-white mb-5">Your Information</h2>
                ...
                <div className="rounded-xl bg-white/60 dark:bg-slate-800/60 p-4 mb-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-slate-800 dark:text-white">
                      {result.prediction === 1 ? 'âš ï¸ Dropout Likely' : 'âœ… No Dropout'}
                    </span>
                  </div>
                </div>
          ...
          {!result && !loading && (
            ...
            >
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                Fill in your details and click <strong>Predict</strong> to evaluate.
              </p>
