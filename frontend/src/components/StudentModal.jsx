...
function riskColor(level) {
  ...
  if (l.includes('high')) return { bg: 'bg-red-50 dark:bg-red-900/20', border: 'border-red-200 dark:border-red-800', text: 'text-red-600 dark:text-red-400', badge: 'bg-red-100 text-red-700 dark:bg-red-800 dark:text-red-200' };
  if (l.includes('medium')) return { bg: 'bg-amber-50 dark:bg-amber-900/20', border: 'border-amber-200 dark:border-amber-800', text: 'text-amber-600 dark:text-amber-400', badge: 'bg-amber-100 text-amber-700 dark:bg-amber-800 dark:text-amber-200' };
  return { bg: 'bg-emerald-50 dark:bg-emerald-900/20', border: 'border-emerald-200 dark:border-emerald-800', text: 'text-emerald-600 dark:text-emerald-400', badge: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-800 dark:text-emerald-200' };
}
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="rounded-xl bg-white/60 dark:bg-slate-800/60 p-3">
              <p className="text-xs text-slate-500 dark:text-slate-400">Prediction</p>
          ...
          {/* Explanation */}
          <div className="mb-6">
            <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">🧠 Analysis</h3>
          ...
          <div className="rounded-xl bg-white/80 dark:bg-slate-800/80 p-4 border border-slate-200/50 dark:border-slate-700/50">
            <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">💡 Recommendation</h3>
